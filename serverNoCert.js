...
//var apiUrl = `http://api.sportradar.com/badminton/${access_level}/v${version}/${language_code}/schedules/${APIyear}-${APImonth}-${APIday}/summaries.${format}?api_key=${api_key}`;
var apiUrl = `http://api.sportradar.com/badminton-t1/en/schedules/${APIyear}-${APImonth}-${APIday}/results.json?api_key=${api_key}`;
...
function getDateTime() {
  ...
  apiUrl = `http://api.sportradar.com/badminton-t1/en/schedules/${APIyear}-${APImonth}-${APIday}/results.json?api_key=${api_key}`;
  //return dateTimeJson;
  return dateString;
}
